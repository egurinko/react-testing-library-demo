...
const descriptions = [
  {
    ...
    full:
      'You can check pokemons in Pokedex page. If you like one of them, go the detail page and add to My Pokemons. My Pokemons could be seen in My Pokemons page.',
  },
  {
